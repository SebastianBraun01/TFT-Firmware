...
#define LEVELING_POINT_XY_FEEDRATE  10000 // (mm/min) X and Y axes move feedrate
...
#define Z_FADE_DEFAULT_VALUE 15.0f

// Probe Offset limits
#define PROBE_OFFSET_MIN_VALUE     -50.0f
...
#define PRINT_START_GCODE "M420 S1\n" // Raise Z 10mm before homing X & Y
