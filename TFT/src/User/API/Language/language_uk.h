...
#define _LANGUAGE_UK_H_
    ...
    #define STRING_SEND_START_GCODE       "Розпочати G-код перед друком"
    #define STRING_SEND_END_GCODE         "Завершити G-код після друку"
    #define STRING_SEND_CANCEL_GCODE      "G-код скасувати друк"
    #define STRING_PERSISTENT_STATUS_INFO "Нагрівання в інфостроці"
    ...
    #define STRING_RESET_SETTINGS_INFO    "Всі налаштування будуть \nскинуті за замовчуванням. \nБажаєте продовжити?"
    ...
    #define STRING_PLR_EN                 "Робота після втрати живлення"
