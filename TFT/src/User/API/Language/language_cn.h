...
#define _LANGUAGE_CN_H_
    ...
    #define STRING_FILAMENT_LENGTH        "使用耗材长度: %1.2fm\n"
    #define STRING_FILAMENT_WEIGHT        "已使用耗材重量: %1.2fg\n"
    #define STRING_FILAMENT_COST          "已使用耗材成本: %1.2f\n"
    #define STRING_NO_FILAMENT_STATS      "无耗材历史数据"
